...
if __name__ == "__main__":
    ...
    u_cp_atoms = u_cp_atoms[:, HIGHLIGHTED_ATOM]

    cps = [initial_crystal_plane, cp_atoms]

    u_cps = []

    for i in range(u_crystal_plane.shape[0]):
        u_cps.append((u_crystal_plane[i], u_cp_atoms[i]))
